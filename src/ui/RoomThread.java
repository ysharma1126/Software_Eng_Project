...
public class RoomThread implements Runnable {
    ...
    private volatile HashSet<Player> players;
    private final ObservableList<UserData> user_data = FXCollections.observableArrayList ();
    
    public RoomThread(Stage primaryStage, ObjectOutputStream outToServer, ObjectInputStream inFromServer, HashSet<Player> players, ObservableList<UserData> user_data ) throws IOException{
