...
public class Browser extends VBox {
  ...
  private void create_room(Stage primaryStage, ObjectOutputStream outToServer, ObjectInputStream inFromServer) {
  ...
  public Browser(Stage primaryStage) {
      ...
      game_tbl.setOnMouseClicked(new EventHandler<MouseEvent>() {
        ...
        public void handle(MouseEvent event) {
            System.out.println("clicked on " + game_tbl.getSelectionModel().getSelectedItem().game_id.get());
            //join_room(primaryStage, outToServer, inFromServer, game_tbl.getSelectionModel().getSelectedItem().game_id.get());
        }
      });
    // menubar = new MenuBar();
...
//        }
    ...
    col_online.setCellValueFactory(
        new PropertyValueFactory<>("Name"));
